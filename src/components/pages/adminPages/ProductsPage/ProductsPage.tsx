    ...
    <>
      ...
      <Content>
        <>
          ...
          {!isDataLoading && isFetchingError && (
            <Placeholder text={product.error.message} />
          )}

          {!isDataLoading && !isFetchingError && !hasCategories && (
            <Placeholder text={ADD_CATEGORY_MESSAGE} />
          )}

          {!isDataLoading && !isFetchingError && !hasBrands && (
            <Placeholder text={ADD_BRAND_MESSAGE} />
          )}
          ...
          {!isDataLoading &&
            ...
            !hasProducts &&
            !hasBrands &&
            !hasCategories && <Placeholder text={NO_PRODUCTS_MESSAGE} />}
